# Generated by Powerlevel10k configuration wizard on 2019-10-21 at 12:44 PDT.
...
() {
  ...
  function prompt_pomodoro() {
    ...
    case "${pomo_status_text[1]}" in
      ...
      B) pomo_status="BREAKING";;
      C) pomo_status="COMPLETE";;
      P) pomo_status="PAUSED";;
      ?) pomo_status="IDLE";;
    esac

    p10k segment -i TOMATO -r -t "$pomo_status_text"  -s $pomo_status
  }

  typeset -g POWERLEVEL9K_POMODORO_RUNNING_FOREGROUND=green
  typeset -g POWERLEVEL9K_POMODORO_PAUSED_FOREGROUND=red
  typeset -g POWERLEVEL9K_POMODORO_BREAKING_FOREGROUND=blue
  typeset -g POWERLEVEL9K_POMODORO_COMPLETE_FOREGROUND=blue
  typeset -g POWERLEVEL9K_POMODORO_IDLE_CONTENT_EXPANSION=''
